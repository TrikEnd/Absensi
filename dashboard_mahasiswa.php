...
if(isset($_POST['hapus'])){
    ...
    $stmt->bind_param("si",$nim,$kelas_id);
    $stmt->execute(); $msg="Kelas berhasil dihapus.";
}
...
$absensi = $conn->query("SELECT a.*, k.nama_kelas FROM absensi a JOIN kelas k ON a.kelas_id=k.id WHERE a.nim='$nim' ORDER BY a.tanggal DESC");
...
<div class="sidebar">
    ...
    <a href="?menu=absensi">Rekap Absensi</a>
</div>
...
<h3>Rekap Absensi</h3>
<table>
<tr><th>Kelas</th><th>Tanggal</th><th>Status</th></tr>
